...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[44rem] md:h-[60rem] flex items-start justify-center relative px-2 md:px-20 pt-0"
      ref={containerRef}
    >
      <div className="py-0 w-full relative" style={{ perspective: "1000px" }}>
        ...
        <motion.div
          ...
          className="max-w-5xl mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-[#6C6C6C] p-2 bg-[#222222] rounded-[30px] shadow-2xl"
        >
